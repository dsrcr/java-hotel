...
public class PremiumAccountTypeTest {
    ...
    public void testPremiumAccountTypeValues() {
        assertEquals("Enum should have 2 values", 2, PremiumAccountType.values().length);
        assertEquals("First value should be PREMIUM", PremiumAccountType.PREMIUM, PremiumAccountType.values()[0]);
        assertEquals("Second value should be PREMIUM_PLUS", PremiumAccountType.PREMIUM_PLUS, PremiumAccountType.values()[1]);
    }
